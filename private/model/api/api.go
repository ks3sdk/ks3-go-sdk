...
func (a *API) resetImports() {
	a.imports = map[string]bool{
		"github.com/ks3sdk/ks3-go-sdk/aws": true,
	}
}
...
func (a *API) APIGoCode() string {
	a.resetImports()
	a.imports["github.com/ks3sdk/ks3-go-sdk/aws/awsutil"] = true
	a.imports["github.com/ks3sdk/ks3-go-sdk/aws/request"] = true
	if a.OperationHasOutputPlaceholder() {
		a.imports["github.com/ks3sdk/ks3-go-sdk/private/protocol/"+a.ProtocolPackage()] = true
		a.imports["github.com/ks3sdk/ks3-go-sdk/private/protocol"] = true
	}

	for _, op := range a.Operations {
		if op.AuthType == "none" {
			a.imports["github.com/ks3sdk/ks3-go-sdk/aws/credentials"] = true
			break
		}
	}
...
func (a *API) ServiceGoCode() string {
	a.resetImports()
	a.imports["github.com/ks3sdk/ks3-go-sdk/aws/client"] = true
	a.imports["github.com/ks3sdk/ks3-go-sdk/aws/client/metadata"] = true
	a.imports["github.com/ks3sdk/ks3-go-sdk/aws/request"] = true
	if a.Metadata.SignatureVersion == "v2" {
		a.imports["github.com/ks3sdk/ks3-go-sdk/private/signer/v2"] = true
		a.imports["github.com/ks3sdk/ks3-go-sdk/aws/corehandlers"] = true
	} else {
		a.imports["github.com/ks3sdk/ks3-go-sdk/aws/signer/v4"] = true
	}
	a.imports["github.com/ks3sdk/ks3-go-sdk/private/protocol/"+a.ProtocolPackage()] = true
...
func (a *API) InterfaceGoCode() string {
	...
	a.imports = map[string]bool{
		"github.com/ks3sdk/ks3-go-sdk/aws":                   true,
		"github.com/ks3sdk/ks3-go-sdk/aws/request":           true,
